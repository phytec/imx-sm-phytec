/**
*   @file    eMcem_FailurePointList_MIMX94XX.h
*   @version 0.4.0
*
...
#ifndef EMCEM_FAILUREPOINTLIST_MIMX94XX_H
#define EMCEM_FAILUREPOINTLIST_MIMX94XX_H
...
*
* @section eMcem_FailurePointList_MIMX94XX_h_REF_0501
...
*
* @section eMcem_FailurePointList_MIMX94XX_h_REF_0502
...
*
* @section eMcem_FailurePointList_MIMX94XX_h_REF_0504
...
*
* @section eMcem_FailurePointList_MIMX94XX_h_REF_0505
...
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0501 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0502 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0504 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0505 */
/*!
* @brief    eMCEM external diagnostic failure point list - SW major version.
*/
#define EMCEM_FAILUREPOINTLIST_MIMX94XX_SW_MAJOR_VERSION             0
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0501 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0502 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0504 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0505 */
...
*/
#define EMCEM_FAILUREPOINTLIST_MIMX94XX_SW_MINOR_VERSION             4
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0501 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0502 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0504 */
/* @violates @ref eMcem_FailurePointList_MIMX94XX_h_REF_0505 */
...
*/
#define EMCEM_FAILUREPOINTLIST_MIMX94XX_SW_PATCH_VERSION             0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and MIMX_SAF version header file are of the same software version */
#if ((EMCEM_FAILUREPOINTLIST_MIMX94XX_SW_MAJOR_VERSION != MIMX_SAF_SW_MAJOR_VERSION) || \
     (EMCEM_FAILUREPOINTLIST_MIMX94XX_SW_MINOR_VERSION != MIMX_SAF_SW_MINOR_VERSION) || \
     (EMCEM_FAILUREPOINTLIST_MIMX94XX_SW_PATCH_VERSION != MIMX_SAF_SW_PATCH_VERSION))
    #error "Software Version Numbers of eMcem_FailurePointList_MIMX94XX.h and MIMX_SAF version are different"
#endif
...
#endif /* EMCEM_FAILUREPOINTLIST_MIMX94XX_H */
